...
% Last Modified by GUIDE v2.5 29-Sep-2017 14:29:57
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_LayoutFcn',  @HardwareSettings_LayoutFcn, ...
                   'gui_Callback',   []);
...
function h1 = HardwareSettings_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/00_Git_repos/Matlab-Arduino-RTData/private/HardwareSettings.m', ...
    'lastFilename', '/home/thomas/00_Git_repos/Matlab-Arduino-RTData/HardwareSettings.fig');
...
'Callback',@(hObject,eventdata)HardwareSettings('PortMenu_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)HardwareSettings('PortMenu_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','PortMenu');
...
'Callback',@(hObject,eventdata)HardwareSettings('DelayEdt_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)HardwareSettings('DelayEdt_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','DelayEdt');
...
'Callback',@(hObject,eventdata)HardwareSettings('ArduinoMenu_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)HardwareSettings('ArduinoMenu_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','ArduinoMenu',...
...
'Callback',@(hObject,eventdata)HardwareSettings('MeasuresEdt_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)HardwareSettings('MeasuresEdt_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','MeasuresEdt',...
'KeyPressFcn',blanks(0));
...
'Callback',@(hObject,eventdata)HardwareSettings('ChannelsMenu_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)HardwareSettings('ChannelsMenu_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'Tag','ChannelsMenu',...
'KeyPressFcn',blanks(0));
...
'Callback',@(hObject,eventdata)HardwareSettings('SetBttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','SetBttn',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % HARDWARESETTINGS('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % HARDWARESETTINGS(...)
